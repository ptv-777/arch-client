...
- Клиент PySide6: поиск → выбор → скачивание → распаковка → запуск просмотрщика на локальной папке, показывает индикатор прогресса, умеет работать с `tar.zst`, ZIP/TAR и ISO.
